      ...
      {properties ? (
        <>
          <Typography gutterBottom variant="subtitle1">
            {ITEM_PROPERTIES_PAINKILLER.title}
          </Typography>
          <Grid
            container
            rowSpacing={1}
          ...
          >
            ...
            {properties.energyImpact ? (
              <>
                ...
                <Grid xs={3}>{properties.energyImpact}</Grid>
              </>
            ) : null}
            {properties.hydrationImpact ? (
              <>
                ...
                <Grid xs={3}>{properties.hydrationImpact}</Grid>
              </>
            ) : null}
            {properties.painkillerDuration ? (
              <>
                ...
                <Grid xs={3}>{`${properties.painkillerDuration} sec`}</Grid>
              </>
            ) : null}
            {properties.useTime ? (
              <>
